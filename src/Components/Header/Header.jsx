...
function Header() {
  return (
    ...
    <ul className='md:flex md:space-x-9 hidden font-semibold text-gray-900'>
      <li className='cursor-pointer hover:text-[#9e3ffd] '>Home</li> 
      <li className='cursor-pointer hover:text-[#9e3ffd] '>Services</li>
